 ...
 */
	...
	elseif (!$Opauth->validate(sha1(print_r($response['auth'], true)), $response['timestamp'], $response['signature'], $reason)){
		...
		echo '<strong style="color: green;">OK: </strong>Auth response is validated. Please wait while we redirect you...'."<br>\n";
...
* Auth response dump
*/
$_SESSION['RESSOCIAL'] = $response;
header('Location: ' . $config['base_url'] . 'social/');
ob_end_flush();