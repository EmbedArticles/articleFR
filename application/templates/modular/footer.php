<footer>
	<div class="footer-panel">
		<div class="footer-links"><a href="<?=$site->base?>pages/v/about" title="About Us">About Us</a> | <a href="<?=$site->base?>register/" title="Register">Register</a> | <a href="<?=$site->base?>login/" title="Login">Login</a> | <a href="<?=$site->base?>terms/" title="Terms of Service">Terms of Service</a> | <a href="<?=$site->base?>contact/">Contact Us</a></div>
