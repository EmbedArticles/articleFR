...
class Akismet
	...
	public function isCommentSpam() {
		...
		//echo '<p>Sending request to ' . $this->wordPressAPIKey . '.rest.akismet.com', '/' . $this->akismetVersion . '/comment-check </p>';
		...
		//echo "<p><small>Response #1 from akismet server: " . $response[0] . "</small></p>";
		//echo "<p><small>Response #2 from akismet server: " . $response[1] . "</small></p>";
