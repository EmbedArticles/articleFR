...
<?php 
	...
	if (isset($_REQUEST['submit']) && $_REQUEST['submit'] == 'submit') {
		...
		if (!$akismet->isCommentSpam()) {
			...
			if (!$_is_adult) {
				$_create = createPage($_REQUEST['url'], $_REQUEST['title'], $_REQUEST['description'], $_REQUEST['keywords'], $_REQUEST['content'], $_conn);
				...
				if ($_create == 1) {
					print '
						<div class="alert alert-success alert-dismissable">
							...
							<b>Alert!</b> Success: Your page has been created.
						</div>
					';										
				} else if ($_create == 0) {
					print '
						<div class="alert alert-danger alert-dismissable">
							<i class="fa fa-ban"></i>
							<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
							<b>Alert!</b> Error: Please choose another URL Slug or Title for your page.
						</div>
					';	
				}
			} else {
			...
			<div class="box box-info">			
				...
				<form method="post" role="form" parsley-validate>
					...
					<div class="form-group">
						...
						<input type="text" name="url" class="form-control" placeholder="URL Slug ..." parsley-trigger="change" required />
					</div>
